...
def get_results(dataset_to_use):
    experiments_path = os.getcwd() + "/exercise_{}_mlp_runs".format(dataset_to_use)
    ...
    a.drop(["n_epochs", "random_seed", "seed", "save_each"], axis=1, inplace=True)
    a.to_excel(os.getcwd() + "/exercise_{}_experiments.xlsx".format(dataset_to_use))
